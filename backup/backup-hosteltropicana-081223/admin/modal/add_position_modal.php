					...
					<!-- main form -->
						<form class="form-horizontal" role="form" id="add-tools-form">
							...
							<div class="form-group">
								<label class="control-label col-sm-3" for="tagID-tools">Tag Identification:</label>
								<div class="col-sm-9">
									<input type="text" class="form-control" id="tagID-tools">
								</div>
							</div>
							...
							<div class="form-group" >
								<label class="control-label col-sm-3" for="room-tools">Room/Area:</label>
								<div class="col-sm-9"> 
									<input type="text" class="form-control" id="room-tools">
								</div>
							</div>
							...
							<div class="form-group" >
								...
								<div class="col-sm-9"> 
								<input type="text" class="form-control" id="quantity-tools" >
								</div>
							</div>
							
							<div class="conatiner" style="display:flex; gap:30px;">

    	...
    	?>
    		<tr>
    			...
    			<?php if($r['status']=='Borrowed'){?>
					...
					<button class="btn btn-sm btn-success" onclick="fill_views_report('<?= $r['id'];?>')">View</button>
					<button class="btn btn-sm btn-warning" onclick="fill_views_report('<?= $r['id'];?>')">Return</button>

...
<div class="container-fluid"> 
	<nav class="navbar navbar-navs" style="margin-top:5px; margin-bottom:5px;">
		<div class="container-fluid">
			<div class="banner">
	...
	<div class="container-fluid navbar-navs" style="height: 75vh;">
	<div class="container-fluid gitna">
			<div class="panel panel-primary" style="width: 50%;margin:0;">
				<div class="panels-head">
					<h3 class="panel-titles">Please Login</h3>
				</div>

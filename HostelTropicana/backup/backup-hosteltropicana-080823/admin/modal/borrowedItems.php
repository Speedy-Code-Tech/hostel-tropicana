                    ...
                    <!-- main form -->
                        ...
                        <br>
                            <div style="display: flex; gap:5px;">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="tagborrowID">
                                </div>
                            </div>
                            <div style="display: flex; gap:5px;">
                                <label class="control-label col-sm-3" for="tagborrowname">Item Name:</label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="tagborrowname">
                                </div>
                            </div>
                            <div style="display: flex; gap:5px;">
                            ...
                            <div style="display: flex; gap:5px;">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="tagwhere">
                                </div>
                            </div>
                            <div style="display: flex; gap:5px;">
                              <div style="width: 100%;">
                                <label class="control-label col-sm-3" for="tagcontact">Contact No:</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="tagcontact">
                                    </div>
                              </div>
                              <div style="width: 100%;">
                                <label class="control-label col-sm-3" for="tagroom">Room:</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="tagroom">
                                    </div>
                              </div>
                            </div>
                            ...
                            <div style="display: flex; gap:5px;">
                              <div style="width: 100%;">
                                <label class="control-label col-sm-3" for="tagcategory">Category:</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="tagcategory">
                                    </div>
                              </div>
                              <div style="width: 100%;">
                                <label class="control-label col-sm-3" for="tagquantity">Quantity:</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="tagquantity">
                                    </div>
                              </div>
                            </div>
                            <div style="display: flex; gap:5px;">
                              <div style="width: 100%;">
                                <label class="control-label col-sm-3" for="tagcategory">Borrowed Date:</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="tagBdate">
                                    </div>
                              </div>
                              <div style="width: 100%;">
                                <label class="control-label col-sm-3" for="tagquantity">Return Date:</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="tagRdate">
                                    </div>
                              </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group" style="padding-bottom: 20px;"> 
                            <div class="col-sm-offset-2 col-sm-10" style="display: flex; gap:30px;">
                                <button type="button" class="btn btn-secondary" style="background-color: yellowgreen;" data-dismiss="modal" aria-hidden="true">Cancel</button>
                            </div>
                        </div>

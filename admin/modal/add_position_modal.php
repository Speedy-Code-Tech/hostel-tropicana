					...
					<!-- main form -->
						<form class="form-horizontal" role="form" id="add-tools-form">
							...
							<div class="form-group" >
								...
								<div class="col-sm-9"> 
								<select name="room" id="room-change-tools" class="form-control" onchange="changeRoomTools()">
									...
									<input type="hidden" class="form-control" id="room-tools">
								</div>
							</div>
							...
							<div class="conatiner" style="float: right; padding-bottom: 20px;">
